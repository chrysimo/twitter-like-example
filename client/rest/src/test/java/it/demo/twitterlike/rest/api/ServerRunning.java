...
public class ServerRunning implements MethodRule {
    ...
    public Statement apply(final Statement base, FrameworkMethod method, Object target) {
        ...
        try {
            client.getForEntity(new UriTemplate(getUrl("/console/login.jsp")).toString(), String.class);
            online = true;
        ...
        postForStatus(savedClient, "/console/oauth/uncache_approvals",
        ...
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                try {
                    ...
                    postForStatus(savedClient, "/console/oauth/cache_approvals",
                            new LinkedMultiValueMap<String, String>());
                }
    ...
    public <T> ResponseEntity<T> postForClass(String path, MultiValueMap<String, String> formData, Class<T> className) {
        return postForClass(path, new HttpHeaders(), formData, className);
    }

    public <T> ResponseEntity<T> postForClass(String path, HttpHeaders headers, MultiValueMap<String, String> formData, Class<T> className) {
        if (headers.getContentType() == null) {
            headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
        }
        return client.exchange(getUrl(path), HttpMethod.POST, new HttpEntity<MultiValueMap<String, String>>(formData,
